...
//    }
    ...
    /**
     * Converts Morphia Key to K, i.e. "_id".
     *
     * @param   <T> the type of the target objects.
     * @param   <K> the type of the unique keys of the obejcts.
     * @param   key    the key.
     * @return  the converted key.
     * @throws  RepositoryException
     *  in case of conversion errors.
     */
    protected static final <T, K extends Serializable> K _key2Id(
                    final Key<T> key
                    )
    {
        K  id = null;
    ...
    /**
     * Converts Morphia Key list to K, i.e. "_id", list.
     *
     * @param   <T> the type of the target objects.
     * @param   <K> the type of the unique keys of the obejcts.
     * @param   keys    a collection of keys.
     * @return  a list of the converted keys.
     */
