...
//                        MediaType.TEXT_XML, MediaType.APPLICATION_XML
     ...
     * @param   string_url  the URL.
     * @param   method      the HTTP method to invoke.
     * @param   callback    the call back handler.
     * @param   extractor   the message extractor.
    ...
    /**
     * @param   media_type  the media type of the object.
     *
     */
...
//    }
    ...
    /**
     * @param   converters  the converters for messages.
     */
