...
public class OQL
{
     ...
     * @param   criteria    the criteria for the objects.
     */
    public OQL(
                    final Class<?> type,
...
//        this( type, aliasFor( type ), criteria );
     ...
     * @param   alias
     *  the alias name for the target objects.
     * @param   criteria
     *  the criteria of the objects.
     */
    public OQL(
                    final Class<?> type,
                    final String alias,
    ...
    /**
     * @return  the type of the query targets.
     */
    ...
    /**
     * @param   orders
     *  the ordering specification of the result objects.
     * @return
     *  a string representation of the OQL order clause.
     */
    public String getOrdering(
