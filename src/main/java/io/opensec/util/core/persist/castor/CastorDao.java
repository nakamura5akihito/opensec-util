...
//    private static Log  _LOG = LogFactory.getLog( CastorDao.class );
     ...
     * Constructor.
     *
     * @param   type    the type of the target obejcts.
     */
    public CastorDao(
...
//    }
     ...
     * @return  true if the specified object is already persistent.
     */
...
//    }
     ...
     *
     * @param   <L>     the type of the unique key.
...
//            _jdoCreate( object );
     ...
     *
     * @param   object      the object.
     * @param   p_object    the peer persistent object.
     */
     ...
     *
     * @param   object  the target object.
     * @param   p_object    the persistence object.
     */
     ...
     * @param   condition   the condition to be hold for success.
     * @param   errorMessage    a message to be shown if the condition is not hold.
     */
