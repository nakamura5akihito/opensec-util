    ...
    extends AbstractPersistable<K>
{
     ...
     * Constructor.
     *
     * @param   <A> the type of the antecendent object.
     * @param   <D> the type of the dependent object.
     * @param   antecendent  the antecendent object.
...
//                                                    final <? extends Persistable<M>> dependent
     ...
     * Constructor.
     *
     * @param   antecendentPID  the persistent ID of the antecendent object.
     * @param   dependentPID    the persistent ID of the dependent object.
     */
    public AssociationEntry(
